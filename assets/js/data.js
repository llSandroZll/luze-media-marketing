...
(function () {
  ...
  window.translations = {
    es: {
      ...
      'spot_patatas_pintor.excerpt': 'Las famosas patatas fritas artesanas de Campo de Criptana, tradicionalmente bañadas en aceite para lograr su firma de sabor local.',
      'spot_patatas_pintor.address': 'C. Antonio Maura, Nº 10, 13610 Campo de Criptana, Ciudad Real',
      'spot_patatas_pintor.hours': 'Lunes a Sábado: 09:00 - 14:00 & 17:00 - 19:00',
      'spot_patatas_pintor.booking': 'Venta Directa',
      'spot_patatas_pintor.price': 'Bolsas desde 1.50€',
      'spot_patatas_pintor.fulldesc': '<p>Patatas Fritas Hermanos Pintor es una institución gastronómica en Campo de Criptana. Elaboradas artesanalmente siguiendo una receta familiar transmitida durante décadas, sus famosas patatas artesanas son tradicionalmente bañadas en aceite para lograr su firma de sabor local, siendo conocidas en toda la comarca por su crujido inigualable y su punto justo de sal.</p><p>Utilizando patatas seleccionadas de primera calidad y un proceso de fritura lento y controlado, ofrecen un aperitivo artesanal único. La parada obligada para locales y viajeros que quieren llevarse el sabor crujiente de Criptana a casa.</p>',
